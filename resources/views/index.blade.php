...
@section('content')
    ...
    <body>
        <main class="container-fluid">
            ...
            <h3 class="text text-warning">Best client: </3>
            <div class="container">
            ...
            <div class="d-flex gap-12 m-5">
                <div id="income-graph" class="flex-grow-1 h-25"> </div>
                <div class="grid w-25">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-text">
                                <h3 class="text text-warning">Total :</h3>
                                <p class="text-center h3"><span class="numeric-value">{{ $recetteTotal }}</span> Ar</p>
                            </div>
                        </div>
                    </div>
